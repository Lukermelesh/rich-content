...
Cypress.Commands.add('addHtml', () => {
  ...
  cy.get(`[data-hook*=${HTML_PLUGIN.INPUT}]`).typeAllAtOnce(
    ...
    '<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Billy and Louie Dog Apparel is a Norway-based small business that can turn any dog into a fashionista.<br><br>Head here to browse their online <a href="https://twitter.com/hashtag/Wix?src=hash&amp;ref_src=twsrc%5Etfw">#Wix</a> store (together with your dog of course!) &gt;&gt; <a href="https://t.co/M9XhahRsjo">https://t.co/M9XhahRsjo</a><a href="https://twitter.com/hashtag/DailyWixInspiration?src=hash&amp;ref_src=twsrc%5Etfw">#DailyWixInspiration</a> <a href="https://twitter.com/hashtag/PetLove?src=hash&amp;ref_src=twsrc%5Etfw">#PetLove</a> <a href="https://t.co/PPKDvdYNNq">pic.twitter.com/PPKDvdYNNq</a></p>&mdash; Wix (@Wix) <a href="https://twitter.com/Wix/status/1241125363272556547?ref_src=twsrc%5Etfw">March 20, 2020</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>'
  );
